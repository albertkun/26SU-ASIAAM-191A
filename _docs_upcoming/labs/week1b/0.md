...
<img src="./media/maptilerapi1.png" alt="">{: style="max-width:500px"}

1. Click on the `New Key` button.

<img src="./media/maptilerapi2.png" alt="">{: style="max-width:500px"}
...
<img src="./media/maptilerapi3.png" alt="">{: style="max-width:500px"}



7. Copy your API key

<img src="./media/maptilerapi4.png" alt="">{: style="max-width:500px"}
...
<img src="./media/maptilerapi5.png" alt="">{: style="max-width:500px"}
...
<img src="./media/maptilerapi6.png" alt="">{: style="max-width:500px"}

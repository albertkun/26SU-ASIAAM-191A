...
<img src="media/click_anywhere.png" alt="">
...
<img src="media/console_log_worked.png" alt="">
...
<img src="./media/answerJS.png" alt="">

2. Type in `js`:

<img src="./media/answerJS2.png" alt="">

3. Click on the `New File` button:

<img src="./media/answerJS3.png" alt="">

4. Give it a name, like `init.js`

<img src="./media/answerJS4.png" alt="">

...
<img src="./media/newFolderCss.png" alt="">{: style="max-width:300px"}

Type in ==styles== to name the folder `styles`:

<img src="./media/newFolderCss2.png" alt="">{: style="max-width:300px"}

Highlight the `styles` folder by clicking on it:

<img src="./media/newFolderCss3.png" alt="">{: style="max-width:300px"}

Then click on the ==New file :material-file-plus:== button:

<img src="./media/newFolderCss4.png" alt="">{: style="max-width:300px"}

Name the file ==style.css==:

<img src="./media/newFolderCss5.png" alt="">{: style="max-width:300px"}

...
<img src="./media/commit1.png" alt="">{: style="max-width:300px"}

Enter a note for your commit:

<img src="./media/commit2.png" alt="">{: style="max-width:300px"}
...
<img src="./media/commit_menu.png" alt="">{: style="max-width:300px"}

- Search ==post commit== in the text box at the top

<img src="./media/commit_search.png" alt="">{: style="max-width:300px"}


- Change the setting from `none` to ==push==

<img src="./media/commit_setting.png" alt="">{: style="max-width:300px"}

- Now the next time you commit by pressing the following shortcut, it will push automatically!
   - **PC:** ++ctrl+enter++
   - **MAC:** ++cmd+enter++

<img src="./media/commit_box.png" alt="">{: style="max-width:300px"}
:::
## Using GitHub Pages
...
<img src="./media/finding_your_repo.png" alt="">{: style="max-width:500px"}

Then click on ==Your repositories==

<img src="./media/finding_your_repo2.png" alt="">{: style="max-width:500px"}

Find ==your assignment== repository and click on it:

<img src="./media/assignment_repo.png" alt="">{: style="max-width:500px"}

 
Click on ==Settings==:

<img src="./media/gitstarted10.png" alt="">{: style="max-width:500px"}

Click on ==Pages==:

<img src="./media/gitstarted11.png" alt="">{: style="max-width:500px"}

and under **Source** , click on the ==main== branch [^1]:

<img src="./media/gitstarted12.png" alt="">{: style="max-width:500px"}

Choose ==root==:

<img src="./media/gitstarted12root.png" alt="">{: style="max-width:500px"}

Click on ==Save==:

<img src="./media/gitstarted12save.png" alt="">{: style="max-width:500px"}

Copy this link:

<img src="./media/gitstartedcopy.png" alt="">{: style="max-width:500px"}
...
<img src="./media/lab_submit_1.png" alt="">{: style="max-width:500px"}

Paste your link in the comment box at the bottom

<img src="./media/lab_submit_paste.png" alt="">{: style="max-width:500px"}

Click on ==Comment== to submit the lab:

<img src="./media/lab_submit_click.png" alt="">{: style="max-width:500px"}

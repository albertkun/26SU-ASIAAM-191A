...
<img src="media/loopbreak.jpg" alt="">
...
<img src="media/900px-0720Hoopa.png" alt="alt text">{: style="max-width:350px"}
...
<img src="media/image-2.png" alt="alt text">

:::caution[Remember! `console.log()` is your life boat! :fontawesome-solid-life-ring:]

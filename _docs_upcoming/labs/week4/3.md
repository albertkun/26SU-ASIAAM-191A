...
<img src="media/gapidarn.png" alt="">{: style="max-width:500px"}
...
<img src="media/error.png" alt="">{: style="max-width:500px"}
...
[<img src="media/papaparse.png" alt="">{: style="max-width:500px"}](https://www.papaparse.com/)
...
<img src="./media/consolelogyay.png" alt="">{: style="max-width:500px"}

...
<img src="./media/gs_0a.png" alt="">{: style="max-width:500px"}

Next, add two columns, one for `lat` and another for `lng`:

<img src="./media/gs_0b.png" alt="">{: style="max-width:500px"}

Now click on ==**Extensions**==

<img src="./media/googleAppScript1.png" alt="">{: style="max-width:500px"}

Now click on ==**Apps Script**==

<img src="./media/googleAppScript2.png" alt="">{: style="max-width:500px"}

When you first launch, you will see a blank ==myFunction()== select it and get ready to paste over it:

<img src="./media/gs_0d.png" alt="">{: style="max-width:500px"}
...
<img src="./media/googleAppScript3.png" alt="">{: style="max-width:500px"}

Click on the ==**Run**== button to test the script:

<img src="./media/gs_4.png" alt="">{: style="max-width:500px"}

You should get a prompt asking for `Authorization`, click ==**Review permissions**==:

<img src="./media/googleAppScript4.png" alt="">{: style="max-width:500px"}


Select your ==**Google Account**== to continue:

<img src="./media/gs_12.png" alt="">{: style="max-width:300px"}


Click on ==Advanced==:

<img src="./media/gs_13.png" alt="">{: style="max-width:300px"}

Click on ==**Go to Untitled Project (unsafe)**==

<img src="./media/gs_14.png" alt="">{: style="max-width:300px"}

Click on ==**Allow**==

<img src="./media/gs_15.png" alt="">{: style="max-width:300px"}
...
<img src="./media/gs_16.png" alt="">{: style="max-width:300px"}

If it ran successfully then you should now see `latitude` and `longitude` filled in the Google Sheet!

<img src="./media/gs_5.png" alt="">{: style="max-width:500px"}
...
<img src="./media/gs_3.png" alt="">{: style="max-width:500px"}

Click on ==:heavy_plus_sign: **Add Trigger**==:

<img src="./media/gs_6.png" alt="">{: style="max-width:500px"}

Click on ==**Select event type**==:

<img src="./media/gs_7.png" alt="">{: style="max-width:500px"}

Change to ==**On Form Submit**== so that everytime the the form gets submitted a new record gets latitude/longitude added too!

<img src="./media/gs_8.png" alt="">{: style="max-width:500px"}

Click ==**Save**==:

<img src="./media/gs_9.png" alt="">{: style="max-width:500px"}

A pop-up should appear, but if you have a pop-up blocker like on FireFox, then you may have to click on `Options`:

<img src="./media/gs_10.png" alt="">{: style="max-width:500px"}

Then ==Allow== this particular popup to appear.

<img src="./media/gs_11.png" alt="">{: style="max-width:300px"}
...
<img src="./media/gs_17.png" alt="">{: style="max-width:500px"}
...
<img src="media/googleForms35.png" alt="">{: style="max-width:500px"}

Click on ==**Sharing**==:

<img src="media/googleSheetsPublish1.png" alt="">{: style="max-width:500px"}

Click on ==**Publish to web**==:

<img src="media/googleSheetsPublish2.png" alt="">{: style="max-width:500px"}

Click on ==**Webpage**==:

<img src="media/googleSheetsPublish3.png" alt="">{: style="max-width:500px"}

Choose ==**CSV**==:

<img src="media/googleSheetsPublish4.png" alt="">{: style="max-width:500px"}

Click ==**Publish**==:

<img src="media/googleSheetsPublish5.png" alt="">{: style="max-width:500px"}

If this warning pops-up click on ==**OK**==:

<img src="media/googleSheetsPublish6.png" alt="">{: style="max-width:500px"}


Copy the URL in the address bar:

<img src="media/googleSheetsPublish7.png" alt="">{: style="max-width:500px"}
...
<img src="media/error.png" alt="alt text">

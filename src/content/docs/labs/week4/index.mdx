...
<img src="/26SU-ASIAAM-191A/labs/week4/media/intro.png" alt="Forms, geocoding, and conditionals intro" style="max-width:300px" />
...
1. [Creating a Google Form](./1)
2. [Geocoding with Google Sheets](./2)
3. [Connecting to our Google Sheet with `papa parse`](./3)
4. [Mapping data with `if-else` conditionals](./4)
...
<LabNav next={{ href: "/labs/week4/1/", label: "Creating a Google Form" }} />

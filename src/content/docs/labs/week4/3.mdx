---
title: "Connecting to APIs and Looping back to Lab 3!"
---
...
<img src="/26SU-ASIAAM-191A/labs/week4/media/gapidarn.png" alt="API diagram" style="max-width:500px" />
...
<img src="/26SU-ASIAAM-191A/labs/week4/media/error.png" alt="Fetch error" style="max-width:500px" />
...
[<img src="/26SU-ASIAAM-191A/labs/week4/media/papaparse.png" alt="Papa Parse" style="max-width:500px" />](https://www.papaparse.com/)
...
<img src="/26SU-ASIAAM-191A/labs/week4/media/consolelogyay.png" alt="Console log success" style="max-width:500px" />

Then you are in good shape for the next part of the lab!

### ⚽ Warm-up: Arrow Functions!

:::tip[Can you convert the function?]
...
```html title="index.html" showLineNumbers {15}
<!DOCTYPE html>
<html>
    <head>
...
```js title="js/init.js" showLineNumbers {38-47}
// declare variables
...
<LabNav prev={{ href: "/labs/week4/2/", label: "Geocoding with Google Sheets" }} next={{ href: "/labs/week4/4/", label: "Mapping data with if-else conditionals" }} />

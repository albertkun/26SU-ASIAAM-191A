---
title: "✅ Final Template Code for Lab 3"
---
...
// When the map is fully loaded, start by adding GeoJSON data named 'untitled.geojson'
...
You can use this template to finish this week's [lab assignment](../../../assignments/week3/lab_assignment/)!

<LabNav prev={{ href: "/labs/week3/3/", label: "For-Loops" }} />

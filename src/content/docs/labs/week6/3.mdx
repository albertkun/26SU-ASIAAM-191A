---
title: "Adding a new MapLibreGL JavaScript Plugin"
---
...
- [https://maplibre.org/maplibre-gl-js/docs/plugins/](https://maplibre.org/maplibre-gl-js/docs/plugins/)
...
<img src="/26SU-ASIAAM-191A/labs/week6/media/image.png" alt="A map where overlapping markers are spread apart so each point is visible" />
...
<img src="/26SU-ASIAAM-191A/labs/week6/media/image-1.png" alt="The maplibre-randomize-overlapping-markers usage documentation showing the module script tag and a PointManager.addPointData example" />
...
<LabNav prev={{ href: "/labs/week6/2/", label: "Working with branches" }} next={{ href: "/labs/week6/4/", label: "Creating a pull request" }} />

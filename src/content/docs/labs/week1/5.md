...
<nav class="lab-nav" aria-label="Lab navigation">
  <a href="./4" class="lab-nav-btn lab-nav-prev">← Publishing with GitHub Pages</a>
  <a href="../../assignments/week1/lab_assignment" class="lab-nav-btn lab-nav-next">Lab Assignment →</a>
</nav>

...
<nav class="lab-nav" aria-label="Lab navigation">
  <a href="/26SU-ASIAAM-191A/labs/week1/3/" class="lab-nav-btn lab-nav-prev">← Adding a Map</a>
  <a href="/26SU-ASIAAM-191A/labs/week1/5/" class="lab-nav-btn lab-nav-next">Final Template Code →</a>
</nav>

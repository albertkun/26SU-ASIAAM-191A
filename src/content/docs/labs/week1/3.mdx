...
<CodeAnnotation
  ...
  annotations={[
    ...
    { line: 2, text: "The `const` keyword declaration keeps a variable **CONST**ant!" },
  ]}
/>
...
2. The `const` keyword declaration keeps a variable **CONST**ant and will never change.
3. The `var` allows variables to change or never change depending on **where** it was declared! VERY PROBLEMATIC!
:::
...
<img src="/26SU-ASIAAM-191A/labs/week1/media/answerJS.png" alt="" />

2. Type in `js`:

<img src="/26SU-ASIAAM-191A/labs/week1/media/answerJS2.png" alt="" />

3. Click on the `New File` button:

<img src="/26SU-ASIAAM-191A/labs/week1/media/answerJS3.png" alt="" />

4. Give it a name, like `init.js`

<img src="/26SU-ASIAAM-191A/labs/week1/media/answerJS4.png" alt="" />
...
<LabNav prev={{ href: "/labs/week1/2/", label: "Writing CSS" }} next={{ href: "/labs/week1/4/", label: "Publishing with GitHub Pages" }} />
